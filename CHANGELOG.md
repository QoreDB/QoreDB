...
- Bump version to 0.1.33 in .SRCINFO and PKGBUILD

## [0.1.33] - 2026-07-02

### Miscellaneous

- Bump package version to 0.1.32 in PKGBUILD and .SRCINFO
- Bump version to 0.1.33 in package.json and Cargo.toml

## [0.1.32] - 2026-06-29

### Bug Fixes

- Update README to reflect 15 native drivers and 8,000+ downloads
- Clarify comment for private internal docs in .gitignore

### Features

- Add v0.1.32 release notes for stabilization and driver updates
- Implement maintenance operations for PostgreSQL and related drivers, enhance EXPLAIN plan localization
- Enhance filtering capabilities across multiple drivers with type casting for LIKE operations
- Add server search functionality to DocumentResults and ResultsViewer components
- Enhance TabButton interaction and add empty namespace messages in multiple languages
- Add license refresh and billing portal management features, enhance localization for seats and related messages
- Enhance license error handling with localized messages for various error scenarios
- Implement SSH host key policy enforcement tests and improve security for sensitive connection metadata
- Add guidelines for code comments and documentation style to enhance clarity and maintainability

### Miscellaneous

- Update dependencies and improve error handling in clickhouse driver
- Bump version to 0.1.32 in package.json and Cargo.toml
- Bump version to 0.1.32 in Cargo.lock

### Refactor

- Clean up and streamline code across multiple modules
- Remove unnecessary comments and documentation across various components
- Remove unnecessary comments and documentation from Tauri commands
- Simplify MongoDB backup argument handling and add tests for password handling
- Consolidate session ID parsing and environment mapping across command modules
- Simplify session manager access across command modules
- Remove unused plugin source files and Cargo.toml configurations
- Remove redundant comments and improve code clarity in DuckDB backup and runner modules
- Enhance table comparison functionality with multi-environment support and improve localization strings
- Replace native window.confirm with promisified confirmDialog across components
- Add CellResultSummary component for AI result summarization and update localization strings
- Implement index suggestions feature with UI components and localization updates
- Integrate execution time display in DataGrid components and optimize GridTimingInfo usage

### Refactoring

- Clean up imports and formatting across multiple components
- Remove unnecessary comments and documentation across multiple files for improved clarity

## [0.1.31] - 2026-06-17

### Bug Fixes

- Improve error handling when disabling Windows Defender in release workflow
- Update Windows platform version from 2025 to 2022 in release workflow

### Features

- Update package version to 0.1.30 and adjust webkit2gtk dependency in update script

### Miscellaneous

- Update workflow to use windows-2025 instead of windows-latest

## [0.1.30] - 2026-06-09

### Bug Fixes

- Add cache control to badge links in README.md

### Features

- Bump package version to 0.1.29
- Update version to 0.1.30 and add changelog entries for new features
- Update @tauri-apps/api and @tauri-apps/plugin-updater versions to 2.11.0 and 2.10.1 respectively; add corepack commands to settings

## [0.1.29] - 2026-05-29

### Bug Fixes

- Update repository links in various documentation files to point to QoreDB organization

## [0.1.28] - 2026-05-17

### Bug Fixes

- Update webkit2gtk dependency to version 4.1 in aur builds (#46)

### Features

- Bump package version to 0.1.27
- Enhance README with updated multi-database support and new features
- Add new screenshots for database, ER diagram, home, query, and table views
...
- **aur**: Update qoredb-bin to v0.1.26

## [0.1.26] - 2026-04-29

### Features

- Add libkrb5-dev dependency to workflow configurations

## [0.1.25] - 2026-04-17

### Features

- Remove outdated Product Hunt checklist and texts
- Update package version to 0.1.24 and add new permissions for GitHub CLI

## [0.1.24] - 2026-04-05

### Features

- Update AUR publishing workflow and PKGBUILD for version 0.1.23
