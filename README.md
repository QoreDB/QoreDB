...
The fast, open-source database client built with Rust. Connect to **31 supported databases** from a single, beautiful interface. Local-first: your data stays yours.
...
<sub>10,000+ downloads · 31 supported databases · Two releases a month · Used in production by indie devs and startups.</sub>
