...
export function OnboardingModal({ onComplete }: OnboardingModalProps) {
  ...
  return (
    ...
    >
      <motion.div 
        className="relative w-full max-w-2xl bg-card border rounded-xl shadow-2xl p-8 overflow-hidden h-[500px]"
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-6 mt-4">
                  <div className="p-6 border rounded-lg bg-card/50 hover:bg-muted/50 transition-colors">
                      ...
                      <h3 className="text-xl font-semibold mb-2">{t('onboarding.concepts.universalTitle')}</h3>
                  ...
                  <div className="p-6 border rounded-lg bg-card/50 hover:bg-muted/50 transition-colors">
                      ...
                      <h3 className="text-xl font-semibold mb-2">{t('onboarding.concepts.localTitle')}</h3>
                      <p className="text-muted-foreground text-sm">
