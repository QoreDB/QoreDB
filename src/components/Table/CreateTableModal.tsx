      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-auto space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            {/* Column header */}
            <div className="grid grid-cols-[1fr_120px_80px_60px_60px_60px_80px] gap-2 text-xs text-muted-foreground px-2">
            ...
            <div className="space-y-1 max-h-[300px] overflow-auto">
              {columns.map((col, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="grid grid-cols-[1fr_120px_80px_60px_60px_60px_80px] gap-2 items-center bg-muted/30 rounded-md px-2 py-1"
                  >
                    <Input
                      value={col.name}
          ...
          {showSQL && generatedSQL && (
            <div className="space-y-2">
              ...
              <pre className="bg-muted/50 p-4 rounded-md text-sm font-mono overflow-auto max-h-[150px]">
                {generatedSQL}
              </pre>
            </div>
          )}
